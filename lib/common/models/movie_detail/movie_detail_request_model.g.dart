...
MovieDetailRequestModel _$MovieDetailRequestModelFromJson(
        Map<String, dynamic> json) =>
    MovieDetailRequestModel(
      adult: json['adult'] as bool,
      backdrop_path: json['backdrop_path'] as String,
      belongs_to_collection: BelongsToCollection.fromJson(
...
Map<String, dynamic> _$MovieDetailRequestModelToJson(
        MovieDetailRequestModel instance) =>
    <String, dynamic>{
